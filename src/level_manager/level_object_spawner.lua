...
function level_object_spawner.construct_relative(object, relative_x_coord, releative_y_coord)
...
function level_object_spawner.construct(object, x_coord, y_coord)
    -- The relative coordinates should be between 0 and 1
    local object_to_spawn = {}
    object_to_spawn.x_coord = x_coord * ScreenWidhtScalingFactor
    object_to_spawn.y_coord = y_coord * ScreenHeightScalingFactor
    object_to_spawn.construct = object.construct
